...
window.Zepto = Zepto, "$" in window || (window.$ = Zepto),
    ...
    function(a) {
        ...
        var e = function(a) {
                var b = a.attr("data-max-size") || "10MiB",
                ...
                switch (a.target.status) {
                    case 200:
                        ...
                        i(b.files, function(a, b, c) {
                            var d = $("<a>");
                            d.attr("href", window.location.origin + "/tmp/" + b.url).attr("target", "_BLANK").text(window.location.origin + "/tmp/" + b.url), $(".file-url", a).append(d)
